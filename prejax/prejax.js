(function() {
  "use strict";
  var cacheDir, cheerio, die, files, fs, makeExtension, mjAPI, nocss, preambleFile, processFile, readFile, tmpDir, writeFile;
  ...
  processFile = function(filename, preamble) {
    ...
    return mjAPI.typeset({
      ...
      $('script[type^="text/x-mathjax"]').each(function() {
        var format, hash, hashFile, promise, text;
        ...
        if (fs.existsSync(hashFile)) {
          promise = readFile(hashFile, 'utf8').then((function(_this) {
          ...
          promise = mjAPI.typeset({
            ...
            return function(data) {
              ...
              return writeFile(hashFile, data.html);
            };
